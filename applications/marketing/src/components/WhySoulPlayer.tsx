...
import { LocalFirstShowcase } from './features/LocalFirstShowcase'
import { MultiUserShowcase } from './features/MultiUserShowcase'
import { DiscoveryShowcase } from './features/DiscoveryShowcase'
import { AudiophileShowcase } from './features/AudiophileShowcase'
import { MobileShowcase } from './features/MobileShowcase'
...
function SupportSection() {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    targetRef.current.rotateX = (y - centerY) / 250
    targetRef.current.rotateY = (centerX - x) / 250
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        ...
        >
          <FadeIn direction="up">
            <div
              className="group relative p-8 md:p-12 lg:p-16 rounded-3xl overflow-hidden"
              style={{
...
export function WhySoulPlayer() {
  return (
    ...
    >
      ...
      {/* Section 1: Actually YOUR Music - 3D Showcase */}
      <LocalFirstShowcase />

      {/* Section 2: Don't Listen Alone - 3D Showcase */}
      <MultiUserShowcase />

      {/* Section 3: Actually Discover Music - 3D Showcase */}
      <DiscoveryShowcase />

      {/* Section 4: Ready for Audiophiles - 3D Showcase */}
      <AudiophileShowcase />

      {/* Section 5: Listen on the Go - 3D Showcase */}
      <MobileShowcase />
