...
///
/// NOTE: These tests are currently disabled because LibraryScanner and ScanConfig
/// are commented out in soul-metadata/src/lib.rs pending architectural updates
/// for multi-source Track type support.

#[cfg(any())] // Disabled - LibraryScanner commented out pending multi-source refactor
mod scanner_tests {

    use soul_core::types::{Permission, PlaylistShare};
    use soul_core::{Playlist, PlaylistId, Storage, Track, TrackId, User, UserId};
